<template>
      ...
      <div class="col">
        <p class="h3 text-success fw-bold">
          ...
          <router-link to="/contacts/add" class="btn btn-success btn-sm">
            NEW<i class="fa fa-plus-circle ms-2" />
          </router-link>
        </p>

        <p class="fst-italic">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nemo magnam ipsam ullam repellat necessitatibus cum
          explicabo, ducimus recusandae illum doloribus sapiente asperiores nam quam nihil, alias provident qui,
          molestias eveniet!
        </p>
  ...
  <div class="container mt-2" v-if="contacts.length > 0">
    <div class="row">
      <div class=" col-md-6 border" v-for="contact of contacts" :key="contact">
...
export default {
  ...
  created: async function () {
    try {
      this.loading = true
      let response = await this.getAllContactData()
